...
**Baseline** (as of v0.28.0, 2026-05-14, 1 000 nodes / 5 000 edges):
- IS-1: 14.37 ms (pg_eddy) vs 14.20 ms (AGE) → **1.01× — PASS**
- IS-3: 15.82 ms (pg_eddy) vs 232.15 ms (AGE) → **14.68× faster — PASS**
